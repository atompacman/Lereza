	...
	static {
		...
		try {
			NO_PARENT_CONTEXT_ELEM_QUERY_TEMPL = TextFileReader.readAsSingleLine(
					config.getString(SQL.MIDIFileIndex.NO_PARENT_CONTEXT_ELEM));
			SING_PARENT_CONTEXT_ELEM_QUERY_TEMPL = TextFileReader.readAsSingleLine(
					config.getString(SQL.MIDIFileIndex.SINGLE_PARENT_CONTEXT_ELEM));
			MULT_PARENT_CONTEXT_ELEM_QUERY_TEMPL = TextFileReader.readAsSingleLine(
					config.getString(SQL.MIDIFileIndex.MULT_PARENT_CONTEXT_ELEM));
		} catch (IOException e) {
