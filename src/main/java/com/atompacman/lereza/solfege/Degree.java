...
public class Degree {
	...
	private Degree(ScaleDegree degreeOnScale, ChordType chord) {
	...
	public static Degree valueOf(ScaleDegree degreeOnScale, ChordType chord) {
		return new Degree(degreeOnScale, chord);
	}
