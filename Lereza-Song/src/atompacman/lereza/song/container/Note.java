...
import atompacman.lereza.common.solfege.Tone;
import atompacman.lereza.common.solfege.Octave;
...
public class Note {
	...
	public Note(int hexValue, Value value, NoteStatus status) {
		this(Pitch.getPitch(Tone.getToneFromHex(hexValue), Octave.getOctaveFormHex(hexValue)), value, status);
