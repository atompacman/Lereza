...
public class Composition {
	...
	public Composition(String title, CompositionSet set, Context context, Piece piece, MidiFile file) {
		this.title = title;
		this.set = set;
		this.context = context;
		this.piece = piece;
		this.file = file;
		if (Log.infos() && Log.print("Composition \"" + title + "\" created from the midi file \"" + file.getFilePath() + "\"."));
	}
