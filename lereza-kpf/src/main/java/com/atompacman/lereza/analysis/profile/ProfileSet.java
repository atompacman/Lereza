package com.atompacman.lereza.analysis.profile;

import java.util.Map;
import java.util.Map.Entry;

import com.atompacman.lereza.analysis.profile.target.TargetPieceStructure;
...
public class ProfileSet {
    ...
    private BiDoubleMap<TargetPieceStructure, Class<? extends Profile>, Profile> profiles;
    ...
    protected void addProfile(TargetPieceStructure tps, Profile profile) {
