...
import com.atompacman.lereza.core.profile.harmonic.PolyphonicProfile;
...
public class TestProfileFormatter {
    ...
    public void basicChart() {
        ProfileReportFormatter formatter = new ProfileReportFormatter(HarmonicProfile.class);
    ...
    public void multipleChart() {
        ...
        formatter.selectParentProfile();
        formatter.addChildProfile(KeyProfile.class);
        formatter.selectChildProfile(KeyProfile.class);
    ...
    public void customBorders() {
        ...
        formatter.addChart("Custom Borders", Importance.NORMAL);
        formatter.selectChart("Custom Borders");
    ...
    public void completeTest() {
        ...
        formatter.setDataAt(2, 0, "Defense");
