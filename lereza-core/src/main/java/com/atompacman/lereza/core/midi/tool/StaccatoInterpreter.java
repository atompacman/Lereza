...
import com.atompacman.lereza.core.midi.sequence.MIDIInstrument.Family;
...
public class StaccatoInterpreter {
    ...
    public static void main(String[] args) {
        ...
        // Main loop
        System.out.println(StringHelper.title("Staccato interpreter"));
        System.out.print("> ");
        String input = keyboard.nextLine();
        while (!EXIT_KEYWORDS.contains(input)) {
            try {
