...
import com.atompacman.lereza.core.piece.AbstractNoteStack;
...
public abstract class AbstractPieceNavigator<T extends AbstractPiece<?>> {
    ...
    public AbstractPieceNavigator(T piece) {
        if (piece.numParts() == 0) {
    ...
    public final AbstractPart getCurrentPart() {
        return piece.getPart(pbt.part);
    }

    public final AbstractBar getCurrentBar() {
