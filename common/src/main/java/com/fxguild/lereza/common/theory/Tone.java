...
public abstract class Tone {
    ...
    private static final EnumCompositeObjectConstructor<Tone> ECOC = 
            EnumCompositeObjectConstructor.of(Tone.class);
    ...
    static Tone fromNoteAndSemitoneValue(NoteLetter note, int semitoneValue) {
